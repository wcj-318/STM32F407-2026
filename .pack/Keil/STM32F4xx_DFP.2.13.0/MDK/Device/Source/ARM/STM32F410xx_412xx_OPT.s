;/*****************************************************************************/
;/* STM32F410xx_412xx_OPT.s: STM32F410xx and STM32F412xx  Flash Option Bytes  */
;/*****************************************************************************/
;/* <<< Use Configuration Wizard in Context Menu >>>                          */
;/*****************************************************************************/
;/*  This file is part of the uVision/ARM development tools                   */
;/*  Copyright (c) 2017 Keil - An ARM Company.                                */
;/*  All rights reserved.                                                     */
;/*****************************************************************************/
...
;//     <o0.19> Sector 3
;//     <o0.20> Sector 4
;//     <o0.21> Sector 5  (only STM32F412)
;//     <o0.22> Sector 6  (only STM32F412)
;//     <o0.23> Sector 7  (only STM32F412)
;//     <o0.24> Sector 8  (only STM32F412)
;//     <o0.25> Sector 9  (only STM32F412)
;//     <o0.26> Sector 10 (only STM32F412)
;//     <o0.27> Sector 11 (only STM32F412)
;//   </h>
;// </h>
